...
public class ProductGUI extends JPanel {
    ...
    public void initComponents() {
        ...
        product.setBackground(new Color(248,247,248));
    ...
    public void updateProduct() {
        if (checkInput()) {
            ...
            System.out.println("Số cột: " + columnCount);
            ...
            double currentCost = (double)dataTable.getValueAt(selectedRow, 4);
            boolean valueChanged = !newProduct.getName().equals(currentName) || !newProduct.getCategoryID().equals(currentCategoryID) || !newProduct.getSized().equals(currentSized)|| (newProduct.getCost()!=currentCost);
            if (productBLL.exists(newProduct))
                JOptionPane.showMessageDialog(this, "Sản phẩm đã tồn tại!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            else if (valueChanged && productBLL.exists(Map.of("NAME", newProduct.getName(), "CATEGORY_ID", newProduct.getCategoryID(), "SIZED", newProduct.getSized(), "COST", newProduct.getCost())))
                JOptionPane.showMessageDialog(this, "Sản phẩm đã tồn tại!", "Lỗi", JOptionPane.ERROR_MESSAGE);
